...
1.  **Chaves de API:**
    ...
    *   (Opcional) Obtenha uma `OPENAI_API_KEY` da OpenAI, caso deseje utilizar os modelos da OpenAI.
...
Suba o contêiner Docker do PostgreSQL com a extensão pgVector habilitada:
...
Execute o script de ingestão para ler o `document.pdf`, dividir em chunks, criar embeddings e armazená-los no PostgreSQL:
